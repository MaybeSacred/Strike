...
public class UnitGameView : GameView
{
	...
	public void SetValues (string name, string health, string ammo, string fuel, UnitRanks rank, int carriedUnitCount, bool stealthed)
	{
		nameText.text = name;
		...
		stealthImage.gameObject.SetActive (stealthed);
	}
	/// <summary>
