...
class GroundProductionGeneral
{
	...
	List<UnitName> EarlyGroundRule (Instance data, Player thisPlayer)
	{
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> TankGroundRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> SniperGroundRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> ResupplyTankRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> FOWRadarRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> MidGroundRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
	...
	/// <param name="data">Data.</param>
	/// <param name="thisPlayer">This player.</param>
	List<UnitName> LateGroundRule (Instance data, Player thisPlayer)
	{
		List<UnitName> outList = new List<UnitName> ();
		// only activates between 2 and 10 turns in
